...
async fn translation_units_can_be_upserted_and_listed() {
    ...
    lorehaven_db::translation::upsert_unit(
        ...
        &lorehaven_domain::translation::TranslationUnitState::Translated,
        None,
    )
    .await
    .expect("upsert unit");
    ...
    lorehaven_db::translation::upsert_unit(
        ...
        1,
        "How are you?",
        Some("Comment allez-vous?"),
        &lorehaven_domain::translation::TranslationUnitState::Pending,
        None,
    )
    .await
