...
--
-- Dialect: PostgreSQL.
-- Timestamps are RFC 3339 UTC text; identifiers are native UUID columns aliased
-- to text on read (ADR 0004).
--
...
ALTER TABLE source_revision_cache_entries ADD COLUMN IF NOT EXISTS etag TEXT;
ALTER TABLE source_revision_cache_entries ADD COLUMN IF NOT EXISTS last_modified TEXT;
