...
-- PostgreSQL twin of migrations/sqlite/0024_media_generalization.sql:
-- TEXT timestamps, BIGINT counters, no JSON columns — identical column
-- names and shapes per the migration-dialect convention (ADR 0004/0019).
--
...
CREATE TABLE IF NOT EXISTS media_collections (
    ...
    owning_account_id UUID REFERENCES accounts (id) ON DELETE CASCADE,
    title             TEXT NOT NULL,
    description       TEXT,
...
CREATE TABLE IF NOT EXISTS media_editions (
    ...
    label             TEXT,
    parent_edition_id UUID REFERENCES media_editions (id) ON DELETE SET NULL,
    published_at      TEXT,
    created_at        TEXT NOT NULL,
    updated_at        TEXT NOT NULL,
    version           BIGINT NOT NULL DEFAULT 1
