...
ALTER TABLE bounties ADD COLUMN IF NOT EXISTS type TEXT NOT NULL DEFAULT 'standard';
ALTER TABLE bounties ADD COLUMN IF NOT EXISTS funded_amount INTEGER NOT NULL DEFAULT 0;
ALTER TABLE bounties ADD COLUMN IF NOT EXISTS activated_at TEXT;
