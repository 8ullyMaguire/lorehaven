...
--
-- SQLite declares the shared integers INTEGER (64-bit here) and the booleans
-- INTEGER 0/1; the PostgreSQL twin declares BIGINT and BOOLEAN. Both hold the
-- same values; only the declarations differ.
...
CREATE TABLE update_checks (
    ...
    found_changes   INTEGER NOT NULL DEFAULT 0,
