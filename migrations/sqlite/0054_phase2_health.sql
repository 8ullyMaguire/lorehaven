...
CREATE TABLE IF NOT EXISTS admin_taste_profile (
    ...
    label         TEXT NOT NULL,
    admin_target  REAL NOT NULL DEFAULT 0.5 CHECK (admin_target BETWEEN 0.0 AND 1.0),
...
CREATE TABLE IF NOT EXISTS work_taste_vectors (
    ...
    vector      TEXT NOT NULL DEFAULT '[]',  -- JSON array of f64, ordered by dimension key sort
...
-- probe work so the profile can expand (positive) or reinforce (negative).
