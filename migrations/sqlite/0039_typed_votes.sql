...
-- enforced by a unique index rather than a composite PRIMARY KEY, because
-- SQLite treats NULLs in a composite primary key as distinct — the wrong
-- behaviour for "one vote per pseud".
...
CREATE TABLE forum_vote_types (
    ...
    weight_bp      INTEGER NOT NULL DEFAULT 1000,
...
CREATE TABLE forum_votes (
    ...
    weight_at_cast_bp INTEGER NOT NULL DEFAULT 1000,
...
CREATE TABLE forum_karma (
    ...
    karma_bp   INTEGER NOT NULL DEFAULT 0,
