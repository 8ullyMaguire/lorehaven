...
CREATE TABLE media_match_proposals (
    ...
    candidate_reference_id   TEXT    NOT NULL REFERENCES media_references (id) ON DELETE CASCADE,
    -- The existing reference this candidate appears to duplicate.
    existing_reference_id    TEXT    NOT NULL REFERENCES media_references (id) ON DELETE CASCADE,
